var app = (function () {
    ...
    /* src/index.svelte generated by Svelte v3.46.1 */
    ...
    function create_catch_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "catch",
    		source: "(1:0) <script>   import { query }",
    		ctx
    	});
    ...
    // (23:33)      {#each data.posts as post}
    function create_then_block(ctx) {
    	let each_1_anchor;
    	let each_value = /*data*/ ctx[1].posts;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*query, posts*/ 1) {
    				each_value = /*data*/ ctx[1].posts;
    				validate_each_argument(each_value);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "then",
    		source: "(23:33)      {#each data.posts as post}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			add_location(h3, file$2, 26, 10, 381);
    			add_location(aside, file$2, 25, 8, 363);
    			add_location(section, file$2, 24, 6, 345);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(24:4) {#each data.posts as post}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	handle_promise(query(/*posts*/ ctx[0]), info);
    	...
    	const block = {
    		c: function create() {
    			...
    			a = element("a");
    			b = element("b");
    			b.textContent = "New Post";
    			t5 = space();
    			info.block.c();
    			add_location(h1, file$2, 15, 2, 144);
    			add_location(header, file$2, 14, 0, 133);
    			add_location(h2, file$2, 19, 4, 207);
    			add_location(b, file$2, 20, 19, 241);
    			attr_dev(a, "href", "/new");
    			add_location(a, file$2, 20, 4, 226);
    			attr_dev(section, "id", "sub-heading");
    			attr_dev(section, "class", "svelte-19wyro7");
    			add_location(section, file$2, 18, 2, 176);
    			add_location(main, file$2, 17, 0, 167);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
...
query {
  ...
  `;
    	...
    	$$self.$capture_state = () => ({ query, posts });
    	return [posts];
    }
    ...
    /* src/post.svelte generated by Svelte v3.46.1 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 23, 2, 447);
    			add_location(header, file$1, 22, 0, 436);
    			attr_dev(label, "for", "title");
    			add_location(label, file$1, 29, 8, 565);
    			attr_dev(input, "id", "title");
    			attr_dev(input, "name", "title");
    			add_location(input, file$1, 30, 8, 606);
    			add_location(div0, file$1, 28, 6, 551);
    			attr_dev(textarea, "placeholder", "content");
    			attr_dev(textarea, "id", "body");
    			attr_dev(textarea, "name", "body");
    			add_location(textarea, file$1, 33, 8, 673);
    			add_location(div1, file$1, 32, 6, 659);
    			attr_dev(button, "type", "submit");
    			add_location(button, file$1, 36, 8, 763);
    			add_location(div2, file$1, 35, 6, 749);
    			add_location(form, file$1, 27, 4, 498);
    			add_location(section, file$1, 26, 2, 484);
    			add_location(main, file$1, 25, 0, 475);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
  ...
  createPost(title:"${title}", body:"${body}") {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function handleSubmit(e) {
    		...
    		query(build(title, body)).then(res => console.log(res)).then(_ => f.goto("/"));
    	}
    	...
    	$$self.$capture_state = () => ({ router: f, query, build, handleSubmit });
    	return [handleSubmit];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file, 8, 1, 159);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Route, Index: Src, Post });
    	return [];
    }
